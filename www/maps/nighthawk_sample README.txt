...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=nighthawk_sample&box=9.756829,47.510879,9.623834,47.421048
...
-----------
  ...
  * nighthawk_sample Height Map (ASTER 30m).png
  ...
  * nighthawk_sample Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * nighthawk_sample Height Map (SRTM3 v4.1).png
  ...
  * nighthawk_sample Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 344m (actual) is equal to 40m in
